...
#include "linearAlgebra/multiscale/CartesianPartitioner.hpp"
...
PartitionerBase::create( LinearSolverParameters::Multiscale::Coarsening params )
{
  switch( params.partitionType )
  {
    ...
    {
      return std::make_unique< MetisPartitioner >( std::move( params ) );
    }
    case LinearSolverParameters::Multiscale::Coarsening::PartitionType::cartesian:
    {
      return std::make_unique< CartesianPartitioner >( std::move( params ) );
    }
    default:
    {
